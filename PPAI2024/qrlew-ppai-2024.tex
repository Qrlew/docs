...
Some are collections of building blocks, such as emph{Google DP} \cite{GoogleDP} which is a library with reference implementations of many differentially private mechanisms in various languages (C++, Go and Java).
Google built higher level applications on top of them: \cite{ZetaSQL}, \cite{PrivacyOnBeam} and \
