...
\begin{enumerate}
    ...
    And because the vector of sums has $\ell^2$ \emph{Global Sensitivity} of $c$, this is an application of the \emph{Gaussian Mechanism} (see: theorem A.1. in \cite{dwork2014algorithmic}) and the mechanism is $\varepsilon, \delta$-differentially private.
\end{enumerate}
