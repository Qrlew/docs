...
\title{\emph{Qrlew} a framework for SQL query rewriting for privacy}
\author{
    %Authors
    % Authors
...
Automatic differentiation in PyTorch \url{https://openreview.net/pdf?id=BJJsrmfCZ}
Frostig et al. 2018 - Compiling machine learning programs via high-level tracing \url{https://mlsys.org/Conferences/2019/doc/2018/146.pdf}

\subsection{Comparable DP SQL papers}

Wilson et al. 2019 - Differentially Private SQL with Bounded User Contribution \url{https://arxiv.org/pdf/1909.01917.pdf}
\ref{wilson2019differentially}
