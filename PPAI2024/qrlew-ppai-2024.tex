...
\begin{itemize}
    \item Berghel et al. 2022 - Tumult Analytics: a robust, easy-to-use, scalable, and expressive framework for differential privacy \cite{berghel2022tumult}
    \item Garrido et al. 2022 - Lessons Learned: Surveying the Practicality of Differential Privacy in the Industry \cite{garrido2022lessons}
    \item Wilson et al. 2019 - Differentially Private SQL with Bounded User Contribution \cite{wilson2019differentially}
    \item Johnson et al. 2018 - Towards Practical Differential Privacy for SQL Queries \cite{johnson2018towards}
\end{itemize}
