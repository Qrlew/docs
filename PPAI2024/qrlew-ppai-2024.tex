...
Before we decribe these phases into more details, let's define the properties we may want to guarantee on each \eph{Relation} and the ones we need for the output.
