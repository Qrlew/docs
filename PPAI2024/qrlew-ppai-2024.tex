...
criteria- Data practitionner has to be privacy expert
- Data practitionner has to learn a new language or API

features
- advanced privacy unit
- 

Some libraries are target a particular 
Google built higher level applications on top of them:  .
...
%     \hline
%     Data practitionner interface & Complex privacy unit & Possibility to use synthetic data & Execution environment\\
%     \hline
